...
private:
    ...
    void createTextureImage()
    {
        ...
        vkDestroyBuffer(device, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    ...
    void createDescriptorSets()
    {
        ...
        {
            throw std::runtime_error("dailed to allocate descriptor sets!");
        }
